...
substrate10 = {
    ...
    "graph": {
        "min_cpu_cost": 2300.0,
        "max_cpu_revenue": 4600,
        "edge_cpu": 700,
        "local_cpu": 0,
        "centralized_cpu": 900,
        "bw": 80000,
        "min_bw_cost": 400.0,
        "max_bw_revenue": 3000.0,
        "max_cpu_profit": 2300.0,
        "max_bw_profit": 2600.0,
    },
    "nodes": [
        {"type": 0, "cpu": 300, "id": 0},
        {"type": 1, "cpu": 100, "id": 1},
...
substrate12 = {
    ...
    "graph": {
        "min_cpu_cost": 3800.0,
        "max_cpu_revenue": 7600,
        "edge_cpu": 500,
        "local_cpu": 600,
        "centralized_cpu": 600,
        "bw": 100000,
        "min_bw_cost": 500.0,
        "max_bw_revenue": 3750.0,
        "max_cpu_profit": 3800.0,
        "max_bw_profit": 3250.0,
        "nodes": [
            {"type": 2, "cpu": 100, "id": 0},
            {"type": 1, "cpu": 150, "id": 1},
            {"type": 0, "cpu": 200, "id": 2},
...
substrate14 = {
    ...
    "graph": {
        "min_cpu_cost": 4600.0,
        "max_cpu_revenue": 9200,
        "edge_cpu": 700,
        "local_cpu": 600,
        "centralized_cpu": 600,
        "bw": 120000,
        "min_bw_cost": 600.0,
        "max_bw_revenue": 4500.0,
        "max_cpu_profit": 4600.0,
        "max_bw_profit": 3900.0,
        "nodes": [
            {"type": 2, "cpu": 100, "id": 0},
            {"type": 2, "cpu": 100, "id": 1},
            {"type": 1, "cpu": 150, "id": 2},
...
substrate16 = {
    ...
    "graph": {
        "min_cpu_cost": 4800,
        "max_cpu_revenue": 9600,
        "edge_cpu": 1200,
        "local_cpu": 0,
        "centralized_cpu": 1200,
        "bw": 1400,
        "min_bw_cost": 700.0,
...
def create_graph_nodes(n: int):
    ...
    # type: [0, 1, 2], cpu: [100: 500], id: 0 to n, in serial order
    substrate_nodes = []
    for i in range(n):
        type = random.choice(j for j in range(3))
        cpu = random.uniform([100, 500])
        substrate_nodes.append({"type": type, "cpu": cpu, "id": id})
...
abilene = {
    ...
    "graph": {
        ...
        "Testbed": 0,
        "min_cpu_cost": 3300,
        "max_cpu_revenue": 6600,
        "edge_cpu": 800,
        "local_cpu": 0,
        "centralized_cpu": 900,
        "bw": 700,
        "min_bw_cost": 350.0,
        "max_bw_revenue": 2625.0,
        "max_cpu_profit": 3300,
        "max_bw_profit": 2275.0,
        "nodes": [
            {
                "type": 1,
                "cpu": 100,
