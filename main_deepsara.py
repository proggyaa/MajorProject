...
def resource_allocation(cn):  # cn=controller
    ...
    for req in sim.granted_req_list:
        ...
        if not rejected:
            ...
            sim.accepted_reqs += 1
            profit_nodes = calculate_metrics.calculate_profit_nodes(
                req, end_simulation_time
            )
            profit_links = (
                calculate_metrics.calculate_profit_links(req, end_simulation_time) * 10
            )
            ...
            a, b, c = calculate_metrics.calculate_request_utilization(
...
def func_twindow(c, evt):
    ...
    sim.granted_req_list, remaining_req_list = prioritizer(
...
def main():
    ...
    for m in arrival_rates:
        ...
        for i in range(repetitions):
            ...
            f = open("deepsara_" + str(m) + "_output.txt", "w+")
